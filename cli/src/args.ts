...
const unsafeArgs = parse<BenchmarkUnsafeArguments>(
    ...
    },
    {
        ...
        headerContentSections: [
            { header: 'Disco benchmark', content: 'npm run benchmark -- [Options]\n' + argExample },
        ],
    }
)
...
supportedTasks = supportedTasks.set(
    defaultTasks.simpleFace.getTask().id,
    defaultTasks.simpleFace.getTask()
)
supportedTasks = supportedTasks.set(
    defaultTasks.titanic.getTask().id,
    defaultTasks.titanic.getTask()
)
supportedTasks = supportedTasks.set(
    defaultTasks.cifar10.getTask().id,
