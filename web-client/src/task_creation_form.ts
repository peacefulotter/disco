...
export const privacyParameters: FormSection = {
  ...
  fields: [
    ...
    },
    {
      ...
      name: "Tau Percentile",
      description:
        "Percentile of Trusted Users for Byzantine-Robust Aggregation",
      yup: yup
        .number()
        .positive()
        .lessThan(1)
  ...
  fields: [
    {
      ...
      name: "Model URL",
      description:
        'URL endpoint serving the initial model files. See <a class="text-disco-cyan hover:text-disco-blue" target="_blank" href="https://www.tensorflow.org/js/guide/save_load#https">Tensorflow.js docs</a> for more information.',
      type: "text",
      yup: yup.string().when(
    ...
    },
    {
      ...
      name: "Weights File",
      description:
        "Alternatively: Initial Tensorflow.js Model Weights in .bin format",
      type: "file",
      yup: yup.string().when(
        "modelURL",
        otherReq((v: string) => !v)
