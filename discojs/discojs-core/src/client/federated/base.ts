...
export class FederatedClient extends Client {
     ...
     */
    async receiveStatistics(trainingInformant: informant.FederatedInformant): Promise<void> {
    ...
    async receiveMetadataMap(key: MetadataKey): Promise<Map<NodeID, MetadataValue> | undefined> {
        ...
        if (received.metadataMap !== undefined) {
            this.metadataMap = Map(
                received.metadataMap.filter(([k, v]) => v !== undefined) as Array<
    ...
    async onRoundEndCommunication(
        ...
        if (
            this.serverResult !== undefined &&
            this.aggregator.add(FederatedClient.SERVER_NODE_ID, this.serverResult, round, 0)
        ) {
